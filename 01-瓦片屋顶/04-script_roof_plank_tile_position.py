...
class OBJECT_PT_CustomCubePanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        # 创建 UI 控件 - 尺寸
        layout.label(text="尺寸设置")
        layout.prop(props, "length")
        layout.prop(props, "width")
        layout.prop(props, "height")

        # 创建 UI 控件 - 位置
        layout.label(text="位置设置")
        layout.prop(props, "pos_x")
        layout.prop(props, "pos_y")
        layout.prop(props, "pos_z")

        # 创建 UI 控件 - 旋转
        layout.label(text="旋转设置（度）")
        layout.prop(props, "rot_x")
        layout.prop(props, "rot_y")
        layout.prop(props, "rot_z")
